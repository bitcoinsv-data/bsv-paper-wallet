...
@media (max-width:640px){
  .sp-st { gap:14px; }
  #sp-seedcount { font-size:12px; letter-spacing:1.2px; }
...
#sp-sheet { transform-origin:top left; }
...
@media print {
  ...
  #sp-sheet { box-shadow:none; padding:0; border:none; transform:none !important; width:auto !important; }
  #sp-sheetwrap { height:auto !important; overflow:visible !important; }
...
(function(){
  ...
  // The sheet is a fixed print layout: on narrow screens, show it scaled down
  // like a print preview instead of letting the tickets collapse.
  function fitSheet(){
    var wrap = document.getElementById("sp-sheetwrap");
    ...
    sheet.style.width = full + "px";
    var s = avail / full;
    sheet.style.transform = "scale(" + s + ")";
    var head = sheet.getBoundingClientRect().top - wrap.getBoundingClientRect().top;
    wrap.style.height = Math.ceil(head + sheet.offsetHeight * s) + "px";
